...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9); // LQDR
...
contract LiquidDriverMe is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9; // LQDR
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LiquidDriver Me";
    string constant _symbol = "LQDRME";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1%
    uint256 public _maxWallet = _totalSupply.div(28); // 3.5%
    ...
    address public autoLiquidityReceiver=0xE7a9635BB381725F7B69b6344b3d0b2e73A87376; //liq address
    address public marketingFeeReceiver=0xE7a9635BB381725F7B69b6344b3d0b2e73A87376; // marketing address
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xE7a9635BB381725F7B69b6344b3d0b2e73A87376;
